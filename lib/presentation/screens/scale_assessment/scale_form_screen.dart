...
class ScaleFormScreen extends StatefulWidget {
  const ScaleFormScreen({Key? key}) : super(key: key);
...
class _ScaleFormScreenState extends State<ScaleFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final formCubit = BlocProvider.of<ScaleFormCubit>(context);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: MultiBlocListener(
          listeners: [
            BlocListener<ScaleFormCubit, ScaleFormState>(
            ...
            child: Column(
              children: [
                RichText(
                  ...
                  text: TextSpan(
                    text: 'WELCOME TO SCALE POST ASSESSMENT ',
                ...
                BlocBuilder<ScaleFormCubit, ScaleFormState>(
  ...
  void showDialogFunction(BuildContext context) {
    final goBack = context.read<ScaleFormCubit>();
            ...
            return CupertinoAlertDialog(
              ...
              actions: [
                ...
                CupertinoDialogAction(
                    onPressed: () {
                      final data =
                          context.read<ScaleFormCubit>().state.answerList;
                      pushUserFormData(
...
class _FormBuildWidgetState extends State<FormBuildWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final sendValue = context.read<ScaleFormCubit>();
    super.build(context);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
