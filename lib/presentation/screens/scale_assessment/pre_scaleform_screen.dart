...
class PreScaleFormScreen extends StatefulWidget {
  const PreScaleFormScreen({Key? key}) : super(key: key);

  @override
  State<PreScaleFormScreen> createState() => _PreScaleFormScreenState();
}
...
class _PreScaleFormScreenState extends State<PreScaleFormScreen> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: MultiBlocListener(
          listeners: [
            BlocListener<PreScaleFormCubit, PreScaleFormState>(
            ...
            child: Column(
              children: [
                RichText(
                  ...
                  text: TextSpan(
                    text: 'WELCOME TO SCALE PRE ASSESSMENT ',
  ...
  void showDialogFunction(BuildContext context) {
    final goBack = context.read<PreScaleFormCubit>();
            ...
            return CupertinoAlertDialog(
              ...
              actions: [
                ...
                CupertinoDialogAction(
                    onPressed: () {
                      final data =
                          context.read<PreScaleFormCubit>().state.answerList;
                      pushUserFormData(
