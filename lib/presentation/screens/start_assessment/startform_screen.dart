...
class StartFormScreen extends StatefulWidget {
  const StartFormScreen({Key? key}) : super(key: key);
...
class _StartFormScreenState extends State<StartFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final formCubit = BlocProvider.of<StartFormCubit>(context);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: MultiBlocListener(
          listeners: [
            BlocListener<StartFormCubit, StartFormState>(
            ...
            child: Column(
              children: [
                RichText(
                  ...
                  text: TextSpan(
                    text: 'WELCOME TO START POST ASSESSMENT ',
                ...
                BlocBuilder<StartFormCubit, StartFormState>(
  ...
  void showDialogFunction(BuildContext context) {
    final goBack = context.read<StartFormCubit>();
...
class _FormBuildWidgetState extends State<FormBuildWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final sendValue = context.read<StartFormCubit>();
    super.build(context);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
