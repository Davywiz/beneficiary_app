...
class PreInspireFormScreen extends StatefulWidget {
  const PreInspireFormScreen({Key? key}) : super(key: key);

  @override
  State<PreInspireFormScreen> createState() => _PreInspireFormScreenState();
}
...
class _PreInspireFormScreenState extends State<PreInspireFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final formCubit = BlocProvider.of<PreInspireFormCubit>(context);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: MultiBlocListener(
          listeners: [
            BlocListener<PreInspireFormCubit, PreInspireFormState>(
            ...
            child: Column(
              children: [
                RichText(
                  ...
                  text: TextSpan(
                    text: 'WELCOME TO INSPIRE PRE ASSESSMENT ',
                ...
                BlocBuilder<PreInspireFormCubit, PreInspireFormState>(
  ...
  void showDialogFunction(BuildContext context) {
    final goBack = context.read<PreInspireFormCubit>();
            ...
            return CupertinoAlertDialog(
              ...
              actions: [
                ...
                CupertinoDialogAction(
                    onPressed: () {
                      final data =
                          context.read<PreInspireFormCubit>().state.answerList;
                      pushUserFormData(
...
class _FormBuildWidgetState extends State<FormBuildWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final sendValue = context.read<PreInspireFormCubit>();
    super.build(context);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
