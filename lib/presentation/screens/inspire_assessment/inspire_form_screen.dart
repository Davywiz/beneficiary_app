...
class InspireFormScreen extends StatefulWidget {
  const InspireFormScreen({Key? key}) : super(key: key);

  @override
  State<InspireFormScreen> createState() => _InspireFormScreenState();
}
...
class _InspireFormScreenState extends State<InspireFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final formCubit = BlocProvider.of<InspireFormCubit>(context);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: MultiBlocListener(
          listeners: [
            BlocListener<InspireFormCubit, InspireFormState>(
            ...
            child: Column(
              children: [
                RichText(
                  ...
                  text: TextSpan(
                    text: 'WELCOME TO INSPIRE POST ASSESSMENT ',
  ...
  void showDialogFunction(BuildContext context) {
    final goBack = context.read<InspireFormCubit>();
