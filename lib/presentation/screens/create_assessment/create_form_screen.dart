...
class _CreateFormScreenState extends State<CreateFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final formCubit = BlocProvider.of<CreateFormCubit>(context);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: MultiBlocListener(
          listeners: [
            BlocListener<CreateFormCubit, CreateFormState>(
            ...
            child: Column(
              children: [
                RichText(
                  ...
                  text: TextSpan(
                    text: 'WELCOME TO CREATE POST ASSESSMENT ',
  ...
  void showDialogFunction(BuildContext context) {
    final goBack = context.read<CreateFormCubit>();
            ...
            return CupertinoAlertDialog(
              ...
              actions: [
                ...
                CupertinoDialogAction(
                    onPressed: () {
                      final data =
                          context.read<CreateFormCubit>().state.answerList;
                      pushUserFormData(
...
class _FormBuildWidgetState extends State<FormBuildWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final sendValue = context.read<CreateFormCubit>();
    super.build(context);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
