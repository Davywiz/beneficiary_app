...
class PreCreateFormScreen extends StatefulWidget {
  const PreCreateFormScreen({Key? key}) : super(key: key);

  @override
  State<PreCreateFormScreen> createState() => _PreCreateFormScreenState();
}

class _PreCreateFormScreenState extends State<PreCreateFormScreen> {
  String? showSkipLogic;
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance!.addPostFrameCallback((_) {
      showCustomDialog(context, AppStrings.createTitle, AppStrings.createText);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final formCubit = BlocProvider.of<PreCreateFormCubit>(context);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: MultiBlocListener(
          listeners: [
            BlocListener<PreCreateFormCubit, PreCreateFormState>(
            ...
            child: Column(
              children: [
                RichText(
                  ...
                  text: TextSpan(
                    text: 'WELCOME TO CREATE PRE ASSESSMENT ',
                ...
                BlocBuilder<PreCreateFormCubit, PreCreateFormState>(
  ...
  void showDialogFunction(BuildContext context) {
    final goBack = context.read<PreCreateFormCubit>();
            ...
            return CupertinoAlertDialog(
              ...
              actions: [
                ...
                CupertinoDialogAction(
                    onPressed: () {
                      final data =
                          context.read<PreCreateFormCubit>().state.answerList;
                      pushUserFormData(
...
class _FormBuildWidgetState extends State<FormBuildWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final sendValue = context.read<PreCreateFormCubit>();
    super.build(context);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
